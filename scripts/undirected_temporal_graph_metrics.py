...
from utils import get_category_indices, spread_points_around_center, add_group_significance, add_LME_significance
...
def time_measures(measure, graph_idx, window = 1, variable = "interactions",
    ...
    elif variable == "approaches" or variable == "HWI_t":
        mode = 'directed'
    else:
