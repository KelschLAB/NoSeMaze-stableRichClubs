...
% 4 step flow from genotype to RC/non-RC with reshuffling, in absolute
% numbers
corr_rc_to_rc = 0.25;
WT_to_RC = 0.37;
mutant_to_RC = 0.07;
...
figure('Name','sankey demo1','Units','normalized','Position',[.05,.2,.5,.56])
links={'con.','RC ', 29; 'mut.','RC ', 2; 'con.','non-RC ', 109; 'mut.', 'non-RC ', 26
    'RC ', 'RC', 6; 'RC ', 'non-RC', 25; 
    'non-RC ', 'RC', 25; 'non-RC ', 'non-RC', 110
    'RC','con. ',31; 'RC', 'mut. ', 0.0; 'non-RC', 'con. ', 107; 'non-RC', 'mut. ', 28};
